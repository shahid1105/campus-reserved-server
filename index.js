...
async function run() {
    try {
        ...
        const usersCollection = client.db("campusReserve").collection("users");

        // const collageCardCollection = client.db("campusReserve").collection("collageCard");
        const collagesRoutesCollection = client.db("campusReserve").collection("collegesRoutes");
        // const collagesNameCollection = client.db("campusReserve").collection("college-name");
        const myCollegeCollection = client.db("campusReserve").collection("my-college");
        ...
        //     const result = await myCollegeCollection.find({ Email: email }).toArray();

        //     res.send(result)
        // })

        // app.get('/collageCard', async (req, res) => {
        //     const result = await collageCardCollection.find().toArray();
        //     res.send(result)
        // })
